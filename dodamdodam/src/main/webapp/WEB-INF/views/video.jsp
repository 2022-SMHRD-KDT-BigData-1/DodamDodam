...
<html lang="ko">
                ...
                <div class="home_contents">
                  ...
                  <div class="miniroom_contents">
                    <div class="blog_list_wrap">
                      <ul>
                      	<li><span style="color: green; font-family: 'Single Day', cursive; font-size: 24px;">EBS 교육 컨텐츠</span>
                      	</li>
                        <li>
  ...
  2. 창의적 감성과 정서적 공감 능력이 풍부한 어린이로 성장할 수 있도록 합니다.
                    ...
                    <div class="blog_list_wrap2">
                      <ul>
                      <li><span style="color: green; font-family: 'Single Day', cursive; font-size: 24px;">쥬니어네이버 교육 컨텐츠</span></li>
                        <li>
