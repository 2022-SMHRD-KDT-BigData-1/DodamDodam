				    ...
				    <div id="board-Content">
						...
						<input type="hidden" name="c_seq" value="${vo.c_seq}">
							<table class="table table-hover table-bordered">
								<tr>
									<td>아이 이름</td>
									<td><input type = "text" value = "${vo.c_name }" name ="c_name"> </td>
								</tr>
								<tr>
									<td>아이 생일</td>
									<td><input type = "text" value = "${vo.c_birthdate }" name ="c_birthdate"></td>
								</tr>
								<tr>
									<td>아이 성별</td>
									<td><input type = "text" value = "${vo.c_gender }" name ="c_gender"></td>
								</tr>
								<tr>
									<td colspan="2">
