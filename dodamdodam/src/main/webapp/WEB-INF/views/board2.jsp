	...
	<div class="bookcover">
		<div class="bookdot">
			<div class="page">
										...
										<nav aria-label="Page navigation example">
											<ul style="justify-content: center" class="pagination">
												...
												<li class="page-item" style="display: inline;"><a
													class="page-link"
													href="board2.do?pageNum=<fmt:formatNumber type="number" maxFractionDigits="0"  value="${back }" />"
												...
												<c:forEach begin="1" end="${endPageNum}" var="i">
													<c:choose>
														<c:when test="${postEnd eq 10 }">
															<li class="page-item" style="display: inline;"><a
																class="page-link" href="board2.do?pageNum=${i}">${i}</a></li>
														</c:when>
														<c:otherwise>
															<li class="page-item" style="display: inline;"><a
																class="page-link" href="board2.do?pageNum=${i}">${i}</a></li>
												...
												<li class="page-item" style="display: inline;"><a
													class="page-link"
													href="board2.do?pageNum=<fmt:formatNumber type="number" maxFractionDigits="0"  value="${back+2 }" />"
				...
				<div class="menu_bar">
					<a href="./home.do" class="menu_button1">&nbsp;&nbsp;홈</a> <a
						href="./diary.do" class="menu_button2">&nbsp;&nbsp;육아일기</a> <a
						href="./photo.do" class="menu_button3">&nbsp;&nbsp;사진첩</a> <a
						href="./boardChoose.do" class="menu_button4">&nbsp;&nbsp;게시판</a> <a
						href="./note.do?pageNum=1" class="menu_button4">&nbsp;&nbsp;육아수첩</a>
					<a href="./info.do" class="menu_button4">&nbsp;&nbsp;육아 정보</a> <a
						href="./video.do" class="menu_button4">&nbsp;&nbsp;교육용 컨텐츠</a>
				</div>
			</div>
		</div>
	</div>
