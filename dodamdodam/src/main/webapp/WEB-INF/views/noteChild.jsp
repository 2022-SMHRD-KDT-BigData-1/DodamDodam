          ...
          <div class="home">
            ...
            <div class="home_main">
              <div class="home_contents" style="overflow: auto; width: 1000px; height: 800px">
              	<div class="page_name">
              		<h1 style="text-align:center; color:#FFA9AA; padding-top:20px;">육아 수첩</h1>
              	</div> 	
					        ...
					        <nav aria-label="Page navigation example">
								<ul style="justify-content: center" class="pagination">
									...
									<li class="page-item" style="display: inline;"><a class="page-link"
										href="noteChild.do?pageNum=
										
										<fmt:formatNumber type="number" maxFractionDigits="0"  value="${back }" />&c_seq=${c}"
									...
									<c:forEach begin="1" end="${endPageNum}" var="i">
										<c:choose>
											<c:when test="${postEnd eq 10 }">
												<li class="page-item" style="display: inline;"><a class="page-link"
													href="noteChild.do?pageNum=${i}&c_seq=${c}">${i}</a></li>
											</c:when>
											<c:otherwise>
												<li class="page-item" style="display: inline;"><a class="page-link"
													href="noteChild.do?pageNum=${i}&c_seq=${c}">${i}</a></li>
									...
									<a class="page-link" href="noteChild.do?pageNum=<fmt:formatNumber type="number" maxFractionDigits="0"  value="${back+2 }" />&c_seq=${c}" aria-label="Next"> 
